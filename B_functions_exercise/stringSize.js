...
// The function should return the string `small` if the
// argument is shorter than 5 characters, `medium` if it is exactly 5 characters,
// and `large` if it is longer than 5 characters.
